...
### 2026-06-14 -- README: polish the maintainer's amended draft

Polished a rough round of maintainer edits to the README into clean prose without changing their intent. Tightened the new tagline ("A Pokémon Red & Blue save editor written in C++/Qt/QML") and intro, simplified the reboot blockquote to "rebuilt from scratch in Qt/C++", fixed a status-section typo, and reworked the convictions list -- the new **Beautiful UI/UX** conviction, plus reworded **Graceful failure** and **No longer a web app** entries. Rewrote the **Assisted custom-code execution** feature bullet and the **Synthetic Natural** randomization vision from first-person notes into readme prose. Build/test/contributing/architecture sections unchanged.
