# Original README (archived artifact, 2019–2020 era)

> **This is the project's original `README.md`, preserved verbatim as a historical artifact from
> the first life of the project (the 2019–2020 era, before the 2026 revival).** It is kept for its
> voice, context, and the reboot story it tells. The live, current README at the repo root
> supersedes it. Do not edit the text below — it is an archive. For the surrounding history see
> [`origins.md`](origins.md) and [`history.md`](history.md).
