...
Rectangle {
  ...
  ScrollView {
    ...
    ColumnLayout {
      ...
      // ---- Mon-wide actions (moved out of the old Toolkit footer button): a Data
      //      group [Reset | Max Out | Correct Data] and an Evolution control
          ...
          Rectangle {
            ...
            RowLayout {
              ...
              SegBtn {
                ...
                onClicked: if(movesTab.boxData) movesTab.boxData.resetPokemon();
              ...
              SegBtn {
                ...
                onClicked: if(movesTab.boxData) movesTab.boxData.maxOut();
              ...
              SegBtn {
                ...
                onClicked: {
                  if(movesTab.boxData) {
                    // (Kept from the old Toolkit: update()'s 5th bool is dropped by
                    // a QML arg glitch, so call the moves correction explicitly.)
                    movesTab.boxData.update(true, true, true, true);
                    movesTab.boxData.correctMoves();
                    movesTab.boxData.cleanupMoves();
                  }
                }
          ...
          Rectangle {
            ...
            RowLayout {
              ...
              SegBtn {
                ...
                enabled: movesTab.boxData ? movesTab.boxData.hasDeEvolution : false
                onClicked: if(movesTab.boxData) movesTab.boxData.deEvolve();
                tip: qsTr("De-evolve this Pokémon.")
              }
              // Static "fish" centrepiece between the two evolution arrows.
              Item {
                ...
                Image {
                  ...
                  source: "qrc:/assets/icons/fontawesome/fish.svg"
                  fillMode: Image.PreserveAspectFit
                }
              }
              SegBtn {
                ...
                enabled: movesTab.boxData ? movesTab.boxData.hasEvolution : false
                onClicked: if(movesTab.boxData) movesTab.boxData.evolve();
