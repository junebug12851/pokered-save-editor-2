        ...
        ColumnLayout {
          ...
          Rectangle {
            ...
            RowLayout {
              ...
              // Max | Re-Roll | Reset for the active kind (double-up = max all,
              // dice = randomize, double-down = reset all to 0).
              Rectangle {
                Layout.alignment: Qt.AlignVCenter
                Layout.preferredHeight: 34
                ...
                RowLayout {
                  ...
                  SegBtn {
                    ...
                    tip: (top.statKind === "DV") ? qsTr("Max all DVs.") : qsTr("Max all EVs.")
                  }
                  SegBtn {
                    icon.width: 18; icon.height: 18
                  ...
                  SegBtn {
                    ...
                    tip: (top.statKind === "DV") ? qsTr("Reset all DVs to 0.") : qsTr("Reset all EVs to 0.")
                  }
                }
              }
            }
          ...
          // ---- Future Shiny: segmented Shiny | Non-Shiny + Re-roll. ----
          Rectangle {
            Layout.fillWidth: true
            Layout.preferredHeight: 56
            color: "transparent"
